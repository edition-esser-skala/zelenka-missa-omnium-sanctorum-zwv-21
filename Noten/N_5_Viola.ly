...
% 		\clef treble
		...
		e8[ \tempoKyrieIB fis] h fis e2~
		e4 dis8 cis8 dis16 \tempoKyrieIFinis h' a g fis e dis cis
		h2\trill\fermata r2 \bar "||" %15 finis
	}
}
...
% 		\clef treble
		...
		\time 9/8 r1*3/8 e8\f dis h e\pE dis h %70
		...
		\time 15/8 g16.-! e32-! h'8[ h,] e4 r8 r e e \tempoChristeFinis e4.~ e \bar "||" %81 finis
	}
}
