...
KyrieIBassFigures = \figuremode {
	...
	<7 _+>2 <5+ 4>4 <\t _+>
	r4. <6 _+>8 <7>4 <6\\>
	\bassFigureExtendersOn <[5+] 4>4 <5+ _+>8 <5+ 2\+> <5+\! _+>4.. <5+ _+>16 \bassFigureExtendersOff
	<5+ _+>1 %15 finis
}
...
ChristeBassiOrgano = {
	\relative c {
		...
		\time 15/8 g16.-! e32-! h'8[ h,] e4 r8 r a, a' \tempoChristeFinis e4.~ e \bar "||" %81 finis
	}
}
...
ChristeBassFigures = \figuremode {
	...
	<9 _+> <8> r <9+> <8> <[6]>
	<9 [_+]> <8 [6]> <[6]> <9> <8 [6]> <6\\>
	<[5+] _+>4 \bassFigureExtendersOn <5+ _+>8 \bassFigureExtendersOff <_!> <6\\ 4 3> <6> %45
	<7 [5+] _+> <6\\ [_+]> <6> <_!> <6\\> <6>
	<[7]>4 <7>8 <7 _+> r <7! 3>
	<7 3> r <7 _+> <[5+] _+>4 \bassFigureExtendersOn <5+ _+>8 \bassFigureExtendersOff
	r <6\\> <6> r4 <[5+] _+>8
	r <6\\> <6> <_+> <[5+] _+> r %50
