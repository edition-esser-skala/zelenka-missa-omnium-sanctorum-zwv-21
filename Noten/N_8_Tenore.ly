...
ChristeTenoreNotes = {
	\relative c' {
		...
		e4 e,8 r1*3/8
		r8 cis' cis fis4 fis,8
		r1*3/8 fis8 h16([ a)] g([ fis)]
		...
		e4 r8 r1*3/8
		\time 12/8 r r r r8 h h
		\time 9/8 e e fis g16([ h,)] h8. fis'16 g16([ h,)] h4 %70
		e8 e8. fis16 dis([ cis?)] h4 r1*3/8
		r r r8 h h
		\tieDashed h4.~ h~ h~
		...
		\time 6/8 R2.
		\time 9/8 R2.*3/2 %80
		\time 15/8 << \oneVoice R4.*5 \\ { s4. s s \tempoChristeFinis s s } >> \bar "||" %81 finis
	}
}
