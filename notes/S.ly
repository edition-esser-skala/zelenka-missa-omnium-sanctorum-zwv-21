...
KyrieISopranoNotes = {
  \relative c' {
    ...
    h8 h fis'2 e4
    dis e2 dis4
    e8 \tempoKyrieIB e, h'2_( ais8.[\trill h16])
    h2. r4
...
CredoSopranoNotes = {
  \relative c' {
    ...
    R1*16 %84
    \tempoEtIncarnatus
      \mvTr a2\pE^\markup \remark "Solo à 3" g4 g %85
    f8([ g] a2) g4
    a a d a8 c
    h!4. a16[ h] c8[ g] c4~
    c h c e~^\tenuto
