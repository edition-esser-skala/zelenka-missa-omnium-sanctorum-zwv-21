...
KyrieIViola = {
  \relative c' {
    ...
    e16\fE e e e c c c c e e e e c' c c c
    d d, d d d d d e f f f f d d e e
    e e e e e e e e e e e e e e e e
    gis gis gis gis gis gis gis gis gis gis gis gis gis gis gis gis
    a a a a h h h h c c c c c c c c %5
    c a a a a a a a d a a a a a a a
    h e d c h a gis fis? e8 gis h e
    e,16 e a a c c e e e,32[ e e e] gis gis gis gis h[ h h h] e e e e
    e,8 a c e dis fis16 e dis cis h a
    g8 c16 h a g fis e dis8 fis16 e dis c? h a %10
    g g' fis? e dis cis h a g h cis? dis? e8 g
    fis e16 fis g8 e fis4.\trill fis8
    e8 \tempoKyrieIB e h' fis e2~
    e4 dis8 cis8 dis16 \tempoKyrieIFinis h' a g fis e dis cis
    h2\trill r2\fermata \bar "||" %15 finis
  }
}
...
ChristeViola = {
  \relative c' {
    ...
    g'16\fE fis e8 dis g16 fis e8 h' %16
    h, g' fis h, g' fis
    g g c16 a fis8 fis fis
    e4 r8 fis a a
    g4\pE r8 fis h h %20
    h\fE c c dis,16[ fis] fis8 r
    h4.\fE^\tenuto c8 r16 e c32( a16.)
    a,4_\tenuto r8 cis'4.\fE^\tenuto
    dis8 r16 fis, dis32 h16. h4\trill_\tenuto r8
    h dis fis h, a' h %25
    dis,\p e fis h, a' h
    e,16\f a fis8.[\trill e16] e32( h16.) g32( h16.) g32( e16.)
    dis'8\p e fis h, a h
    dis\f e fis h, a h
    cis16\p fis fis8.[\trill e16] e g\f c( h ais h) %30
    g16.-! e32-! a8[ h] e32( h16.) g32( h16.) g32( e16.)
    e,4 r8 r4 r8
    e'\p dis h e dis h
    r c g' fis4 r8
    g\f h h fis a a %35
    g g a dis, fis d16[ c]
    \mvTr h4\f-\tenuto r8 a'32(\p e16.) c32( e16.) c32( a16.)
    \mvTr a4.\fE_\tenuto cis4\ff^\tenuto r8
    h'32(\p fis16.) dis32( fis16.) dis32( h16.) \mvTr h4.\fE\trill_\tenuto
    dis8\pE^\critnote h dis r e d? %40
    cis a cis r d e
    fis4 d8 g4 e8
    a4 fis8 h h, g'
    a a, fis' g g, e'
    fis,\f gis? ais h cis d %45
    ais\pE h cis h cis d
    g,\fE r cis fis, r h
    e,\pE r eis fis gis ais
    h cis d e, r fis
    h cis d e fis fis %50
    fis\f d r fis16.^\critnote g32 e8[ fis]
    ais,16 e''( d cis h ais) h g( fis eis? fis e)
    d16. e32 cis8.[\trill h16] h4 r8
    R2.*2 %55
    h8\f d d g g g
    g\p g a a4\fE r8
    R2.*2
    r4 r8 h4.\fE^\tenutoE %60
    c8 r16 e c32( a16.) a,4\trill r8
    cis'4.\ff^\tenutoE dis8 r16 fis, dis32( h16.)
    h4-\tenuto r8 r dis\p fis
    g4 e8 a4 fis8
    h h, gis' a a, fis' %65
    g g, e' fis h, c
    a a' h c a h
    g16\f fis e8[ dis] g16 fis e8[ h']
    \time 12/8 h, g' fis h, g' fis g g g fis fis fis
    \time 9/8 r4 r8 e\f dis h e\pE dis h %70
    r c g' \appoggiatura g fis4 r8 g8\fE h h
    fis a a g\pE h a h4 r8
    fis8\f dis fis e fis g h, cis dis
    e\p fis g c,4 fis8 h,4 e8
    \time 6/8 a, r ais h cis dis %75
    \time 9/8 e fis, g a r h e fis g
    \time 6/8 a^\adlibitum r h e32(\f h16.) g32( h16.) g32( e16.)
    \time 12/8 fis4. h,8 a' h dis,\p e fis h, a' h
    \time 6/8 e,16\f a fis8.[\trill e16] e16 e'( c h ais h)
    \time 9/8 g16.-! e32-! a8-![ h-!] dis,16 a'( g fis e dis) e c'( h ais h fis) %80
    \time 15/8 g16.-! e32-! h'8[ h,] e4 r8 r e e \tempoChristeFinis e4.~ e\fermata \bar "||" %81 finis
  }
}
...
KyrieIIViola = {
  \relative c' {
    ...
    e4 e e4. e8
    e4 a2 a4
    \tempoKyrieIIFinis a2 a\fermata \bar "|." %150 FINIS
  }
}
...
GloriaViola = {
  \relative c' {
    ...
    fis,4 r r2
    R1*3 %82
    a8\fE^\critnote a'16 gis a8 a, g g'16 fis g8 g,
    ...
    e4^\critnote r r2
    R1*3
    r2 g,8\fE^\critnote g'16 fis g8 g, %95
...
QuiTollisViola = {
  \relative c' {
    ...
    dis4-! h' h cis r h
    h8. c16 a4 h e, r r\fermata \bar "||" %220 finis
  }
}
...
QuoniamIIViola = {
  \relative c' {
    ...
    \mvTr gis'8\pE-\markup \remark "con sordino" h gis e %232
    e e16 fis gis8 h
    fis h cis h
    h4 r8 h\fE %235
    dis, fis16 dis h8 h'
    ...
    e^\adlibitumE r
    R2
    \mvTrr e8\ff-\markup \remark "senza sordino" e fis fis
    e h' h gis
    fis fis e h' %390
    h gis gis gis
    fis4 r8 fis
    ...
    h-! gis'-! r fis %410
    e e e dis
    e h gis4\fermata \bar "||" %412 finis
  }
}
...
CumSanctoViola = {
  \relative c' {
    ...
    e2-\critnote r\fermata \bar "|." %522 FINIS
  }
}
...
CredoViola = {
  \relative c' {
    ...
    r8 g e cis a4 r
    r2 r4 r8 d %75
    g f es d c-\markup \remark "moderato" b a g
    fis e d c b' a g4
...
SanctusViola = {
  \relative c' {
    ...
    g8.[ d16\p d8. d16] d4-\critnote r\fermata \bar "||"
    ...
    e4 e4. e8 dis2 r4\fermata \bar "||" %82 finis
  }
}
...
AgnusDeiViola = {
  \relative c' {
    ...
    e2-! c-! r e-! gis-! r %10
    c,-! e-! r e-! gis-! a
    r g-! h-! r f-\markup \remark "sempre staccato" a
    r e gis r d fis
    r c e c2. c4 h2
    a f' e e1 r2 %15
    e\p r e e r a,
...
DonaNobisViola = {
  \relative c' {
    ...
    e4 e e4. e8
    e4 a2 a4
    \tempoDonaNobisFinis a2 a\fermata \bar "|." %110 FINIS
  }
}
