...
KyrieIBassoNotes = {
  \relative c {
    ...
    a4 e a,( a')
    e r r e
    c'8[ h16 a] gis8[ e] c[ e a c] %5
    f[ e16 d] c8[ a] f[ a d f]
    e[ d16 c] h8[ gis] e4 e'
    e2 e,8[ gis h d]
    e,[ a c e] dis[ fis16 e] dis[ cis h a]
    g8[ c?16 h] a[ g fis e] dis8[ fis16 e] dis[ c? h a] %10
    g[ g' fis e] dis8[ fis] g[ a16 h] c8[ a]
    h4 e, h2
    << \context Voice = "Basso" {
      \oneVoice e4 d c2
      h2. r4
...
DonaNobisBassoNotes = {
  \relative c {
    ...
    e4) a, e'2(
    a4) a, d2
    \tempoDonaNobisFinis a'1\fermata \bar "|." %110 FINIS
  }
}
