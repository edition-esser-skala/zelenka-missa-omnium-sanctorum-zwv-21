...
KyrieIIAltoLyrics = \lyricmode {
  ...
  \x e -- lei -- son,
  Ky -- ri -- e e --
  \xE lei -- son, e -- lei -- %140
  \x son, Chri -- ste e -- \xE lei --
  \x son, Chri --
  ste, Chri --
  ste, Chri -- ste e --
  lei -- _ %145
...
GloriaAltoLyrics = \lyricmode {
  ...
  am, pro -- pter ma -- gnam,\x
  pro -- pter ma -- gnam
  glo -- ri -- am tu --
  am. %75

  \xE Do -- mi -- ne De -- us, %83
  Rex coe -- les --
  \x tis, Do -- mi -- ne %85
  De -- us, Rex coe --
  les -- tis, De -- us __
...
QuoniamIIAltoNotes = {
  \relative c' {
    \clef treble
    \twofourtime \key e \major \time 2/4 \autoBeamOff \tempoQuoniamII
...
CredoAltoNotes = {
  \relative c' {
    ...
    R1*16 %84
    \tempoEtIncarnatus
      \mvTr f2\pE^\markup \remark "Solo à 3" e4 e %85
    f( e d4.) d8
    cis4 r r fis
    g f8 d g4.( a8
    d,2) e4 r
...
CredoAltoLyrics = \lyricmode {
  ...
  um,\x Pa -- trem o -- mni -- po -- ten --
  tem, fa -- cto -- rem coe -- li,
  coe -- li et ter -- ra,
  vi -- si -- bi -- li -- um o -- mni -- um,
  et in -- vi -- si -- bi -- li -- um, %30
  et in -- vi -- si --
  bi -- li -- um.
